...
def test_native_default_off_catalog_order_and_project_independence(tmp_path):
    ...
    assert [p['name'] for p in plugin_catalog()] == ['10BMMultiChannel', 'B18', 'BM23', 'CMC', 'DUBBLE', 'HXMA', 'LNLS', 'Lytle', 'PFBL12C', 'SLRIBL4', 'SPEC', 'SRS', 'SSRLA', 'SSRLB', 'SSRLmicro', 'X10C', 'X15B', 'X23A2MED', 'X23A2MultiChannel', 'Zip']
